...
class DataManager:
    ...
    @staticmethod
    def init():
        DataManager.letter_width = DataManager.parse_letter_widths('Data/letter_width.txt')

    @staticmethod
    def update_letters_width():
        DataManager.letter_widths = utils.calculate_width_letters('textures/Verdana_B_alpha.png')
